export default[
    {
        name:'Blog Title',
        desc:'An AI tool that generate blog title information',
        category:'Blog',
        icon:'/blog-title.png',
        aiPrompt:'Give me 5 blog topic idea in bullet wise only base on give niche and outline and give reason in Rich text editor formate',
    ...
    },
    {
        ...
        desc: 'An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.',
        icon: '/instagram-post-generator.png',
        category: 'blog',
    ...
    },
    {
        ...
        desc: 'An AI tool that serves as your personal blog post title writer, generating catchy and viral-worthy titles in your chosen language.',
        icon: '/instagram-hash-tag-generator.png',
        category: 'blog',
    ...
    },
    {
        ...
        icon: '/instagram-post-idea-generator.png',
        category: 'instagram',
    ...
    },
    {
        ...
        icon:'/english-grammer-checker.png',
        category: 'english',
